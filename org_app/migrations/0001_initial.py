    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='org_app.Category', verbose_name='Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='org_app.Organisation')),
            ],
        ),
        migrations.CreateModel(
            name='OrgDetail',
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('org_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='org_app.Organisation')),
            ],
        ),
    ]
